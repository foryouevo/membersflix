...
// em app/(portal)/ (/inicio, /cursos, /perfil, /curso/[slug]...) — mesmo
// header/bottomnav/checagem de sessão em QUALQUER rota que precise deles,
// sem duplicar a busca de profile/config/categorias/instrutores nem a
// lógica de redirect. Único Server Component "de verdade" usado por dois
// layout.tsx diferentes (um por prefixo de rota — Next.js não deixa um
// layout.tsx só cobrir rotas em prefixos diferentes sem repetir o arquivo
// em cada pasta, mas o CORPO pode — e deve — ser o mesmo).
export default async function MembrosLayoutShell({ children }: { children: React.ReactNode }) {
